...
$route['set-alamat/(:num)'] = 'pelanggan/set_alamat';
$route['form-edit-alamat/(:num)'] = 'pelanggan/form_edit_alamat';
$route['update-alamat/(:num)'] = 'pelanggan/update_alamat';
$route['remove-alamat/(:num)'] = 'pelanggan/remove_alamat';
