  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Transaksi Konfirmasi Pembayaran</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="alert alert-info fade in alert-dismissible show">
                ...
                </button>    <strong>Info!</strong> Pilih Menu Action ->Detail Pemesanan, Untuk Melakukan Konfirmasi Pemesanan.
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <td>
                          <div class='btn-group'>
                            ...
                            <div class='dropdown-menu' role='menu' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(67px, -165px, 0px);'>
                              <a class='dropdown-item detail' href='".base_url('admin/detail-konfirmasi-pembayaran/' .$value->id_pemesanan .'/false')."'>Detail Pemesanan</a>
                            </div>
                          </div>
                        </td>
                      </tr>
