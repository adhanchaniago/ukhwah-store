  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Informasi supplier</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url() ?>admin/beranda">Beranda</a></li>
              <li class="breadcrumb-item active">Informasi supplier</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo base_url() ?>admin/form-data-supplier" class="btn btn-default float-right form-add-new"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <td>
                          <div class='btn-group'>
                            ...
                            <div class='dropdown-menu' role='menu' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(67px, -165px, 0px);'>
                              <a class='dropdown-item edit' href='".base_url('admin/edit-form-data-supplier/' .$value->id_supplier)."'>Edit</a>
                              <a class='dropdown-item delete' href='".base_url('admin/delete-data-supplier/' .$value->id_supplier)."'>Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
...
<script>
  ...
  $(document).on('click', '.form-add-new', function(e){
    ...
    $.get($(this).attr('href'), function(data){
      $('#myModal .modal-title').html('Tambah Data Informasi supplier');
  ...
  $('.edit').on('click', function(e){
    e.preventDefault(); 
    $.get( $(this).attr('href'), function(data){
      $('#myModal .modal-title').html('Edit Informasi supplier');
      $('#myModal .modal-body').html(data);
      $('#myModal').modal('show');
    } ,'html');
  });
