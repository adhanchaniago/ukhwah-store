        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-pemesanan-produk" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Pemesanan Produk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-konfirmasi-pembayaran" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-supplier" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Supplier</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-kategori" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Kategori Produk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-produk" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Produk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-pelanggan" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Pelanggan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/data-ongkir" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Ongkir</p>
                </a>
              </li>
